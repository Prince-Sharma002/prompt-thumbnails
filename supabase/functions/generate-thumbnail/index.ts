// v3 - Uses Lovable AI Gateway for image generation
const corsHeaders = {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log("v3 - Generating thumbnail with prompt:", prompt);
    ...
    console.log("Thumbnail generated successfully, image data length:", imageUrl.length);
